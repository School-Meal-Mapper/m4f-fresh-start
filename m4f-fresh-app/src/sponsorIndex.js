...
const sponsors = {
  chccs: {
    ...
    spreadsheetUrl:
      'https://docs.google.com/spreadsheets/d/e/2PACX-1vTFe6Buc13kn4q2Y9EbAw-ysICh5XRFnpeZvr4sl6VFbNrhaDdj2AxW8LsBsk0FHPGAOt56qWCWgB26/pub?gid=0&single=true&output=csv',
    faqUrl:
      'https://docs.google.com/spreadsheets/d/e/2PACX-1vTFe6Buc13kn4q2Y9EbAw-ysICh5XRFnpeZvr4sl6VFbNrhaDdj2AxW8LsBsk0FHPGAOt56qWCWgB26/pub?gid=144826883&single=true&output=csv',
    providerinfoUrl:
      'https://docs.google.com/spreadsheets/d/e/2PACX-1vTFe6Buc13kn4q2Y9EbAw-ysICh5XRFnpeZvr4sl6VFbNrhaDdj2AxW8LsBsk0FHPGAOt56qWCWgB26/pub?gid=1284762822&single=true&output=csv',
 ...
 * ### Concerns
 *
 * Similar to the old districtData.js, this is still not the best way to do theming specific to a sponsor.
...
export default function sponsorData(abbr) {
  abbr = abbr || 'mff'; // defaults to mff if no abbreviation is given

  let sp = sponsors[abbr];

  if (sp === undefined) {
    // if abbreviation isn't defined, also default to mff's theme
    sp = sponsors['mff'];
  }
